...
CONFIRM_EMAIL_BODY = 'gp_app/emails/acc_active_email.html'
BOOKER_EMAIL_AFTER_CANCELLATION = 'gp_app/emails/cancellation_email_to_reserver.html'
...
class SendAlertEmail:
    def __init__(self, send_to_email, full_name, **kwargs):
        message = get_template(
            'gp_app/emails/alert_email.html').render(
            {
...
class ContactUs:
    def __init__(self, first_name, last_name, email, need, message):
        ...
        message = "Message de la part de {} {} a propos de son {}: {} ({})".format(
...
class ToReserverAndPoster:
    def __init__(self, **kwargs):
        ...
        SendEmailsAfterReservation(email_to_poster=True, **kwargs)
        # Send email to reserver
        SendEmailsAfterReservation(email_to_reserver=True, **kwargs)
...
class SendEmailsAfterReservation:
    def __init__(self, email_to_poster=False, email_to_reserver=False, **kwargs):
        ...
        message = get_template(
            'gp_app/emails/after_reservation_email.html').render(
            {
                'departure_date': kwargs['departure_date'],
                'departure': kwargs['departure'],
                'destination': kwargs['destination'],
